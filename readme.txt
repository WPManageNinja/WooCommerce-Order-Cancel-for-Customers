...
Tags: woo commerce, cancel-order, cancel order, order cancel for certain times, handle cancel order, WooCommerce add-on
...
The manual installation method involves downloading this plugin and uploading it to your webserver via your favourite FTP application. The WordPress codex contains [instructions on how to do this here](https://codex.wordpress.org/Managing_Plugins#Manual_Plugin_Installation).
...
[GitHub repository](https://github.com/WpManageNinja/WooCommerce-Order-Cancel-for-Customers) :)
